...
#merge data with dist to cloest
#remove coords values
#pop_centriods_data <- pop_centriods_data_all #loaded in previous data, and reset to pop_centriods_data. still didn't work. 20141119
#pop_centriods_data$OA11CD <- NULL
...
#save(pop_centriods_data_census, file = "20141120_census_data_OAs.Rdata")
#save(pop_centriods_data_census, file = "20150213_census_data_OAs.Rdata")
#save(pop_centriods_data_census, file = "20150225_census_data_OAs.Rdata")
...
#write.csv(pop_centriods_data_census_cor, file = "20141120-pop_centriods_data_census_cor.csv")
